...
execute as @e[tag=point] store result score @s out run data get entity @s Pos[0] 100.0
execute at @e[tag=rotator] if score @s id = @e[tag=rotator,limit=1,sort=nearest] id store result score @s out run data get entity @e[tag=rotator,limit=1,sort=nearest] Pos[0] 100.0
