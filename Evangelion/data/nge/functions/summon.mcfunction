...
data merge entity @e[limit=1,sort=nearest,tag=new,tag=leftForearm] {item:{id:"name_tag",Count:1b,tag:{CustomModelData:420006}},height:15,width:15}
data merge entity @e[limit=1,sort=nearest,tag=new,tag=leftForearm] {transformation:{translation:[10.4f,-5.9f,-1.49f],scale:[10.0f,10.0f,10.0f]}}

data merge entity @e[limit=1,sort=nearest,tag=new,tag=rightForearm] {item:{id:"name_tag",Count:1b,tag:{CustomModelData:420007}},height:15,width:15}
data merge entity @e[limit=1,sort=nearest,tag=new,tag=rightForearm] {transformation:{translation:[-10.4f,-5.9f,-1.49f],scale:[10.0f,10.0f,10.0f]}}
...
ride @e[tag=new,tag=leftForearm,limit=1,sort=nearest] mount @e[tag=new,tag=leftArm,limit=1,sort=nearest]
ride @e[tag=new,tag=rightForearm,limit=1,sort=nearest] mount @e[tag=new,tag=rightArm,limit=1,sort=nearest]
